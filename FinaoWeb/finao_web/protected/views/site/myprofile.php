...
//    }
    ...
    //function slide_next(uploaddetail_id)
//    {
//        $("#carousel"+uploaddetail_id).carousel('next');  
//    }
//    function slide_previous(uploaddetail_id)
//    {
//        $("#carousel"+uploaddetail_id).carousel('prev');  
//    }
                ...
                <div class="left-rounded-box white-background" style="padding: 8px 5px 8px 8px;">
                    <div class="entered-finaos entered-finaos-black">
                        <ul>
                          ...
                          <a href="index.php?r=site/myprofile" >  <li class="current">Posts</li></a>
                            ...
                            if($finao_recent_post->status == 1)
                            {
                                ...
                                ?>                                                                         
                                    <div class="row "  id="row<? echo $finao_recent_post->finao_id; ?>">                                        
                                        <div class="row col-lg-12 col-md-12 col-sm-12" style="margin: 0px 0px 10px -13px;">
                                        ...
                                        <div class="col-lg-11 col-md-11 col-sm-11 margin-20px img-responsive" > 
                                             <?                                                
                                                ...
                                                elseif((count($finao_recent_post->videourls) + count($finao_recent_post->image_urls)) == 1)
                                                {
                                                    if (count($finao_recent_post->videourls) == 1)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                                <div style="height:620px; background: #161618;">
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                                <img class="left-photos" src="<? echo $image_path."blank.gif"; ?>" style="background-image: url('<? echo $image_url->image_url; ?>'); max-height: 600px; width: 100%; background-repeat: no-repeat; background-position: top center; background-size: 100% auto;"/>
                                                            <?
                                                        }
                                                    }
                                                }
                                                            ...
                                                            <div class="carousel slide row" data-ride="carousel" data-interval="false" id="carousel<? echo $finao_recent_post->uploaddetail_id; ?>">
                                                                ...
                                                                <?
                                                                    ...
                                                                    {   //echo (count($image_urls) . " - " .count($videourls));
                                                                        ?>
                                                                            <a class="left carousel-control" href="#carousel<? echo $finao_recent_post->uploaddetail_id; ; ?>" data-slide="prev" style="margin-left:12px!important;">
                                            ...
                                            <div class="row col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="row col-lg-12 col-md-12 col-sm-12">
                                                  ...
                                                  <div class="col-lg-8 col-md-8 col-sm-8 col-sm-push-2 right">
