    ...
    <div class="modal-dialog ">
        <div class="modal-content" style="border-radius:1px;">
                    ...
                    <div class="row signup-container-fields">
                        <form class="form-signin" role="form" id="signup">
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="col-lg-12 col-md-11 col-sm-12 form-group">
                                <p>
            ...
            <div style="padding: 0;" id="signupbutton">
                <div >
                    <button class="button-signup no-border" style="width:100%;" id="signup_submit">SIGN UP</button>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog modal-sm1">
    <div class="modal-content" style="border-radius: 1px;">
      <div align="right" style="margin-top: -15px; margin-right: -15px;">
		...
		<div class="row">
			<div class="landing-videoWrapper" style="width:557px; height:288px; margin-top:30px; padding-left:30px!important;">
			<iframe src="//www.youtube-nocookie.com/embed/HQiYkSiohus?rel=0&modestbranding=1" frameborder="0" width="557px" height="288px" allowfullscreen="" style="margin-left:15px;"></iframe>
		  </div>
      </div>  
    </div>
  </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6" style="margin-left: 25px;">
        <div class="row">
          ...
          <div class="button-explore col-md-8 col-sm-12">
            <a href="#" data-toggle="modal" data-target=".bs-modal-sm1" style="color: #FFF; text-decoration: none;">What's FINAO</a>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3"></div>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6">
      <div class="landing-videoWrapper">
        <iframe width="437" height="288" src="//www.youtube-nocookie.com/embed/vjtIo1_YQxY?rel=0&modestbranding=1" frameborder="0" allowfullscreen></iframe>
      </div>
    </div>
