...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('secondary_email')); ?>:</b>
	<?php echo CHtml::encode($data->secondary_email); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('mageid')); ?>:</b>
	<?php echo CHtml::encode($data->mageid); ?>
	<br />
	...
	<?php echo CHtml::encode($data->socialnetworkid); ?>
	<br />
	...
	<?php echo CHtml::encode($data->trackid); ?>
	<br />
