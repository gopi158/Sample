        ...
        <div class="profile-picture">
           ...
           <?php /*if(isset($userinfo)){?>
...

			{
				...
				$src=Yii::app()->baseUrl."/images/uploads/profileimages/".$userinfo->profile_image;
			...
			<img src="<?php //echo $src;?>" width="210" height="160"/>

			</div>

                       <div class="welcome"><?php //echo Yii::app()->session['login']['username']; ?></div>
 ...
 <div class="main-container">						
	...
	<div class="finao-canvas">
		...
		<div class="step-details">
                ...
                <span class="right step-area">&nbsp;<!--Step 2--></span>
		...
		<div id="mesg"></div>
		  ...
		  <div class="welcome-run-text">Everyone has a FINAO. Enter yours here or you can skip this step for later.</div>
	...
	<div class="orange font-20px">Select Tile</div>
			...
			<input type="hidden" id="tilename" />
				...
				<table id="tiledisplaynew" width="100%" cellpadding="3" cellspacing="10">
				...
				<tr>
					...
					?>
              		...
              		<td>
	                  	...
	                  	<div class="holder smooth" id="div-<?php echo str_replace(" ", "-",$eachtile->lookup_name);?>-<?php echo $eachtile->lookup_id;?>" onclick="clickdiv(this.id)">

					  	<img src="<?php echo Yii::app()->baseUrl;?>/images/tiles/<?php echo str_replace(" ","",strtolower($eachtile->lookup_name));?>.jpg" width="80" title="<?php echo $eachtile->lookup_name; ?>"/>
		...
		<p class="padding-15pixels">

		<span>

		<?php echo $form->radiobutton($model,'finao_status_Ispublic',array('id'=>'ispublic','checked'=>'checked','name'=>'ispublic'));?>

		Make FINAO Public?
		<?php  echo $form->radiobutton($model,'finao_status_Ispublic',array('name'=>'ispublic'));?>

		Make FINAO Private?</span>
	...
	<div class="center">
			<?php if(isset($skip) && $skip=="dashboard")
					$skipurl = "motivationmesg";
				else
					$skipurl = "landing";
			
			?>
			<input type="button" id="skip" class="btn-next-step" onclick="navigate('<?php echo $skipurl;?>');" value="Skip" />
		...
		<!--<input type="button" class="orange-button" value="save and add another finao" id="addanotherfinao" onclick="submitfinao(<?php //echo $userid;?>,'addanotherfinao','tilefinao')"/>-->
			...
			<!-- changed tilefinao to firstfinao for redirecting to dashboard modified on 18-04-2013-->
...

{
	...
	$("#tiledisplaynew .holder-active").addClass("holder smooth").removeClass("holder-active");
	//alert("kjjkj");
...

{
	...
	//if(ispublic == 'false'){ var ispublics=0; }
	//if(ispublic == 'true') { var ispublics=1;}
	
	//alert(ispublics); return false;
		...
		$.post(url, { userid : userid , tileid : tileid , finaomesg : finaomesg , tilename : tilename , ispublic : ispublic},
	   		...
	   		function(data){
...

				{
					...
					else if(redirecttype=="addanotherfinao")// added else here for redirecting to dashboard
...
function navigate(redurl)

{

	if(redurl=="landing")
	{
		redirecturl = "<?php echo Yii::app()->createAbsoluteUrl('/profile/landing');?>";
	}
	else if(redurl=="motivationmesg")
	{
		redirecturl = "<?php echo Yii::app()->createAbsoluteUrl('/finao/motivationmesg');?>";
	}
	var url = redirecturl;
