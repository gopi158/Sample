...
<div id="divCoverimg" style="z-index:111; width:1000px" class="finao-canvas">
			<a class="btn-close" href="<?php echo Yii::app()->createUrl('group/dashboard',array('groupid'=>$isgroup)); ?>"  ><img src="<?php echo $this->cdnurl; ?>/images/close.png" width="40" /></a>
...
else if($_REQUEST['imgupload'] == 2){//exit;
