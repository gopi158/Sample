...
class MessageController extends Controller
{
	...
	{
		$this->header = 'network';
		$this->networkheader = 'mailbox'; // Added on 29-01-2013
	...
	public function actionNew()
	{
		...
		if(isset($_POST['Mailbox']['to']))
		{
			...
			$userRec= User::model()->findByAttributes(array('userid'=>$conv->interlocutor_id));
			if($validate)
			{
				$conv->save();
				$msg->conversation_id = $conv->conversation_id;
				$msg->save();
						$subj = "Parentvalet Notifications";
