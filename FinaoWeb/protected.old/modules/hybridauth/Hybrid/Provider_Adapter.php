	...
	*/
	function factory( $id, $params = NULL )
	{
		...
		if( isset( $this->config["wrapper"] ) && is_array( $this->config["wrapper"] ) ){
			...
			require_once Hybrid_Auth::$config["path_providers"] . ucfirst($this->id) . ".php" ;
			//echo $config["path_providers"]."--".$this->id;
			//require_once ("/home/content/95/5263695/html/pv-development/protected/modules/hybridauth/Hybrid/Providers/yahoo.php") ;
