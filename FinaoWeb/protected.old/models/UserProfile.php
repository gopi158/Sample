...

{
...

	{
		...
		return array(
			...
			array('mystory', 'length', 'max'=>8000),

			array('user_location', 'length', 'max'=>100),

			array('IsCompleted', 'length', 'max'=>10),
			...
			array('user_profile_id, user_profile_msg, user_location, IsCompleted, mystory,profile_image, profile_bg_image, profile_status_Ispublic, createdby, createddate, updatedby, updateddate', 'safe', 'on'=>'search'),
