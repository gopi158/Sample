...
<!-- BEGIN CYCLE -->
	...
	<div class="pics" id="Cycle"> 
					...
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide1">
								...
								<p><a href="http://biziindia.com/fspeakers/speakers/mike-smith/" class="CycBTN Left">Read more</a></p>
                            </div>
						</div>
					</div>
			</div>
					...
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide2">
								...
								<p><a href="http://biziindia.com/fspeakers/speakers/patrick-perez/" class="CycBTN Left">Read more</a></p>
                            </div>
						</div>
					</div>
			</div>
					...
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide2">
								...
								<p><a href="http://biziindia.com/fspeakers/speakers/scott-backovich/" class="CycBTN Left">Read more</a></p>
                            </div>
						</div>
					</div>
			</div>
					...
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide1">
								...
								<p><a href="http://biziindia.com/fspeakers/speakers/eddie-slowikowski/" class="CycBTN Left">Read more</a></p>
                            </div>
						</div>
					</div>
			</div>
					...
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide2">
								...
								<p><a href="http://biziindia.com/fspeakers/speakers/aric-bostick-2/" class="CycBTN Left">Read more</a></p>
                            </div>
						</div>
					</div>
			</div>
          	<div>
 				<img src="<?php echo get_template_directory_uri(); ?>/images/06.png" width="986" height="400" class="CycIMG"/> 
					<div class="CycSlideContent">
						<div class="CycDetails">
                        	<div class="Slide1">
                            	<h3>FINAO NATION</h3>
                            	<p>Failure is not an option... <a href="#" class="orange-link">Read more</a></p>
        ...
        <div style="float:right; margin:0 25px 10px 0;"><a href="http://biziindia.com/finaospeakers/speakers/" class="orange-link font-15px" id="viewall">View All Speakers</a></div>
	</div>
<!-- END CYCLE -->
