...
function twentytwelve_setup() {
	...
	//Code added for cropping the image with custom width and height  by LK
	/*if ( function_exists( 'add_image_size' ) ) { 
	//add_image_size( 'category-thumb', 300, 9999 ); //300 pixels wide (and unlimited height)
	add_image_size( 'speaker', 320, 320, true ); //(cropped)
	}*/
...
/**
*The Code below is to load the Speaker based there tags
*http://wordpress.stackexchange.com/questions/96584/how-do-i-filter-posts-by-taxomony-using-ajax
*
*/
