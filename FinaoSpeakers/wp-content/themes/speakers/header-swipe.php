	...
	jQuery(function () {
		...
		$('div.tabs ul.tabNavigation a').click(function () {
...

			{
				...
				$('#supr').load('<?php echo get_template_directory_uri();?>/supr.php');
...
<div class="MainWrapper">
  ...
  <!--<div class="logo"><a href="index.html" style="margin-left:5px;"><img src="images/logo.png" /> </a></div>-->
