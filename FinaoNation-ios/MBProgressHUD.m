...
#define LABELDETAILSFONTSIZE 9.0f
...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
            ...
            dims = [self.labelText sizeWithAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:16.0f]}];
        }
        else
        {
            dims = [self.labelText sizeWithAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:16.0f]}];
        ...
        if (nil != self.detailsLabelText) {
            ...
            CGSize labelSize = [detailsLabel.text sizeWithAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:12.0f]}];
...
- (id)init {
    return [self initWithFrame:CGRectMake(0.0f, 0.0f, 27.0f, 27.0f)];
}
