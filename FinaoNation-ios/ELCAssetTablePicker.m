...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.columns = self.view.bounds.size.width / 80;//MADHU HERE WE CAN INCREASE AND GIVE THE NUMBER OF ASSETS TO BE DISLAYED IN A ROW
}
...
{
	return 79;//MADHU GIVES HEIGHT AT THE PICK PHOTOS SELECTION
}
