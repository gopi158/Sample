...
@synthesize Pri_Public, spamBtn, inspireStatus;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        ProfileImage = [[UIButton alloc]initWithFrame:CGRectMake(17, 5, 40, 40)];
        ProfileImage.layer.borderColor = [UIColor grayColor].CGColor;
        ProfileImage.layer.borderWidth = 1.0f;
        [self.contentView addSubview:ProfileImage];
        
        ProfileName = [[UILabel alloc] initWithFrame:CGRectMake(28, 10, 160, 27)];
        ...
        Finao_Symbol = [[UIImageView alloc]initWithFrame:CGRectMake(8, 50, 10, 10)];
        ...
        Finao_msg2.frame = CGRectMake(13, 370, 270, 30);
        ...
        Finao_detail_table = [[UITableView alloc]initWithFrame:CGRectMake(25, 70, 280, 315) style:UITableViewStylePlain];
        ...
        shareBtn.frame = CGRectMake(205, 395, 30, 25);
        [shareBtn setImage:[UIImage imageNamed:@"spam_btn"] forState:UIControlStateNormal];
        [self addSubview:shareBtn];
        
        inspireStatus = [[UIButton alloc] init ];
        inspireStatus.frame = CGRectMake(250, 395, 50, 25);
        inspireStatus.layer.borderColor = [UIColor orangeColor].CGColor;
        inspireStatus.layer.borderWidth = 1.0f;
        inspireStatus.backgroundColor = [UIColor orangeColor];
        inspireStatus.titleLabel.textColor = [UIColor whiteColor];
        [inspireStatus.titleLabel setTextAlignment:NSTextAlignmentCenter];
        inspireStatus.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:11.0];
        inspireStatus.titleLabel.adjustsFontSizeToFitWidth = YES;
        
        [self addSubview:inspireStatus];
        ...
        finao_status.frame = CGRectMake(20, 395, 50, 20);
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HomeDetailSubCell *cell = (HomeDetailSubCell *)[tableView dequeueReusableCellWithIdentifier:@"HomeDetailSubCell"];
    
    if(cell == nil)
        cell = [[HomeDetailSubCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"HomeDetailSubCell"];
...
-(void)ChangeFramesHomecell{
    ...
    shareBtn.frame = CGRectMake(205, 395, 30, 20);
    inspireStatus.frame = CGRectMake(250, 395, 50, 20);
    finao_status.frame = CGRectMake(10, 395, 50, 20);
}

-(void)ChangeFrameShare{
    shareBtn.frame = CGRectMake(205, 100, 30, 20);
    inspireStatus.frame = CGRectMake(250, 100, 50, 20);
    finao_status.frame = CGRectMake(10, 100, 50, 20);
}

-(void)ChangeToVideoFrames{
    Finao_Symbol.frame = CGRectMake(10, 260, 12, 12);
    Upload_text.frame = CGRectMake(50, 260, 230, 35);
    Finao_detail_table.hidden = YES;
    shareBtn.frame = CGRectMake(205, 260, 30, 20);
    inspireStatus.frame = CGRectMake(250, 260, 50, 20);
    finao_status.frame = CGRectMake(10, 395, 50, 20);
}
